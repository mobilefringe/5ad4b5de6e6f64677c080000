require.config({
    paths: {
        ...
        'slice-slider' : 'http://preview-5ad4b5de6e6f64677c080000.codecloudapp.com/slice_slider'
    }
});
    ...
    const vm = new Vue({
        ...
        data: function() {
            return {
                ...
                stickyMenu: false,
                isSticky: 700,
                property_logo : "//codecloud.cdn.speedyrails.net/sites/5ad4b5de6e6f64677c080000/image/png/1522945080899/mmlogo500.png"
            }
        },
        created() {
